...
> Stack-agnostic disciplines (`architect`, `drafter`, `detective`, `inspector`, `archivist`, `surveyor`) live in the [`dev-core`](../dev-core/) plugin, not here. `react-debug` is the React-specialized cousin of `detective`.
